...
public final class JennyRebornConfig {
    ...
    private static final ForgeConfigSpec.IntValue MAGIC_NUMBER = BUILDER
            ...
            .defineInRange(
                    "magicNumber", JennyRebornConstants.CONFIG_DEFAULT_MAGIC_NUMBER, 0, Integer.MAX_VALUE);
    ...
    private static final ForgeConfigSpec.ConfigValue<List<? extends String>> ITEM_STRINGS = BUILDER
            ...
            .defineListAllowEmpty("items", List.of("minecraft:iron_ingot"), JennyRebornConfig::validateItemName);
